...
public class ConsultarConsulta extends JFrame {
	...
	public ConsultarConsulta() {
		...
		JLabel lblInformeAbaixo = new JLabel("Informe, abaixo, a data da consulta que deseja consultar:");
		lblInformeAbaixo.setBounds(20, 12, 440, 15);
		contentPane.add(lblInformeAbaixo);
		
		JLabel lblInformeAbaixoO = new JLabel("Informe, abaixo, o horario da consulta que deseja consultar:");
    ...
    private class TrataBotoes implements ActionListener{
        ...
        public void actionPerformed (ActionEvent e){
            ...
            ConsultarConsulta.this.dispose();
        }
    }
}